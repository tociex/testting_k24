        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <img alt="image" width="50%" height="50%" class="rounded-circle" src="<?php echo base_url('assets/dist/aplikasi/Untitled1.png'); ?>"/>
             ...
             <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="<?php echo base_url('admin/man_user'); ?>">Management User</a></li>
                     <li><a href="<?php echo base_url('admin/man_member'); ?>">Management Member</a></li>
                </ul>
            </li>
